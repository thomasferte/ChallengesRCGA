...
def genetic_sampler_from_df(perf_df, hp_df, Npop, Ne, pmutQuant = .5, pmutCat = .25, sigma = 1, sigma_halv_thresh = 6, sigmahalv = 10):
...
def csv_sampler(path_file, data_path, output_path, scenari, array_id = 1, Npop = 200, Ne = 100, nb_trials = 3200, date = '2021-03-01', units = 500, pmutQuant = .5, pmutCat = .25, sigma = 1, sigmahalv = 10):
